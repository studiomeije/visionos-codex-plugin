...
- When the app needs an entire authored entity that already contains materials,
  switch to `realitykit-visionos-developer` in the Build with RealityKit plugin
  and use its `entity-loading-and-stored-entities.md` reference instead of
  repeating stored-entity loading guidance here.
