...
| `usd-editor` / `visionos-runtime-loading.md` | When checking how authored USD or USDZ content loads inside a visionOS app. |
| `usd-editor` / `apple-runtime-boundaries.md` | When deciding whether to edit authored USD, load through RealityKit, or validate for Apple platforms. |
